...
POSE_GRAPH.optimize_every_n_nodes = 20 --매핑에 비해 낮춰줘야함

-- POSE_GRAPH.optimize_every_n_nodes = 0
POSE_GRAPH.global_sampling_ratio = 0.01 -- 0.003 -- 전역 매칭 샘플링 비율
...
-- POSE_GRAPH.optimize_every_n_nodes = 20 -- 최적화 빈도를 증가
