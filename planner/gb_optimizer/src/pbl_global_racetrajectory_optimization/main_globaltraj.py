...
def main_globaltraj(track_name: str,
                    curv_opt_type: str,
    ...
    file_paths["track_name"] = track_name                                 # Modena 2019
    ...
    if opt_type == "mintime" and not mintime_opts["recalc_vel_profile_by_tph"] and lap_time_mat_opts["use_lap_time_mat"]:
        raise IOError("Lap time calculation table should be created but velocity profile recalculation with TPH solver "
                      "is not allowed!")
