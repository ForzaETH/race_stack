...
class OnlineTrajectoryHandler(object):
    ...
    def calc_paths(self,
        ...
        if valid_solution_last_step:
            if "left" in self.__last_action_set_nodes.keys():
                temp_id = "left"
            elif "right" in self.__last_action_set_nodes.keys():
                temp_id = "right"
            elif "straight" in self.__last_action_set_nodes.keys():
                temp_id = "straight"
            elif "follow" in self.__last_action_set_nodes.keys():
                temp_id = "follow"
            else:
                temp_id = None
        
        if valid_solution_last_step and temp_id is not None:
    ...
    def calc_vel_profile(self,
        ...
        for action_id in list(self.__last_action_set_path_param.keys()):
            ...
            for i in range(len(self.__last_action_set_path_param[action_id])):
                ...
                if vel_bound or action_id in ["straight"]:
