...
for map_dir in os.listdir('maps'):
    map_subfolders.append(
        (os.path.join(
            'share', package_name, 'maps', map_dir), glob(
            'maps/{}/*'.format(map_dir), recursive=True)))
...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config', 'NUC1'), glob(os.path.join('config', 'NUC1', '*/*'), recursive=True)),
        (os.path.join('share', package_name, 'config', 'NUC1'), glob(os.path.join('config', 'NUC1', '*.yaml'))),
        ...
        (os.path.join('share', package_name, 'config', 'NANO1'), glob(os.path.join('config', 'NANO1', '*/*'), recursive=True)),
        (os.path.join('share', package_name, 'config', 'NANO1'), glob(os.path.join('config', 'NANO1', '*.yaml'))),
