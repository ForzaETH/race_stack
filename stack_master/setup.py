...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config', 'NUCNUC'), glob(os.path.join('config', 'NUCNUC', '*/*'), recursive=True)),
        (os.path.join('share', package_name, 'config', 'NUCNUC'), glob(os.path.join('config', 'NUCNUC', '*.yaml'))),
